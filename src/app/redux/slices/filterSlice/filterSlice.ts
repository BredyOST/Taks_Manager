    ...
    tasksActive: [
        {
            id: 1,
            title: 'Соцсети',
            subtitle: 'Создание площадки',
            taskText: 'Создать площадку для торговли товарами через корею. Для этого создаем модуль и начинаем его копоновать',
            dataStart: '01-10-2023',
            dataEnd: '02-10-2023',
            index: IndexTasks.activeTask,
        },
        {
            id: 2,
            title: 'Путешествие',
            subtitle: 'Создание площадки контроля продаж и покупок',
            taskText: 'Слетать в дубай и прикупить там веще для дальнейшей эксплуатации',
            dataStart: '01-10-2023',
            dataEnd: '02-10-2023',
            index: IndexTasks.activeTask,
        },
